    ...
    <div id="faq" className="dark yellow chunk">
      <div className="ui two column stackable container center aligned grid">
        ...
        <div>
          ...
          <p className="answer">
            We're working on an update that will let you search for people based
            on interests filters. Stay tuned!
          </p>
          ...
          <p className="answer">
            After meeting someone, you have the option of sending them some
            emojis that describe how cool you thought they were. Other than
            that, only your interests and bio are displayed to others for the
            purpose of helping your matches know more about you before the
            meeting. No private information will ever be displayed to others.
          </p>
        </div>
      </div>
    </div>
